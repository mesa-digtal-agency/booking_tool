...
<header class="bg-white border-b border-neutral-200">
    <div class="max-w-3xl mx-auto flex items-center justify-between px-4 py-4">
        <div class="flex items-center gap-3">
            <?php if ($logo): ?>
                <img src="<?= e($logo) ?>" alt="" class="w-10 h-10 rounded-full object-cover">
            <?php else: ?>
...
<main class="max-w-3xl mx-auto p-4 pb-24">
        ...
        <form id="detailsForm" class="space-y-3" autocomplete="on">
            ...
            <div class="grid md:grid-cols-2 gap-3">
                <label class="block">
                    ...
                    <input required name="customer_phone" type="tel" class="w-full mt-1 px-3 py-2 rounded-lg border border-neutral-200 focus:border-primary focus:ring focus:ring-primary/20">
                </label>
                <label class="block">
    ...
    <section data-panel="5" class="panel hidden">
        ...
        <p id="confirmError" class="text-sm text-red-600 mt-3 hidden"></p>
    </section>
